...
public class HappyPattern implements PatternRuleSet {
   // Empty constructor
   public HappyPattern() {/* do nothing */ };
   
   // Enum which contains all the chord types, which can be used to determine chords regardless of key.
   private enum Chords { OneMajor, TwoMajor, ThreeMajor, FourMajor, FiveMajor, SixMajor; }
   ...
   private Chords getNextChord(Chords prevChord) {
    // Viable chords: 2, 3, 4, 5, 6
      ...
      // Viable chords: 3, 5
      else if(prevChord == Chords.TwoMajor) {
   ...
   private String getChordNotes(Chords chord) {
      ...
      if(chord == Chords.OneMajor)
         return " Cmajw";
      else if(chord == Chords.TwoMajor)
         return " Dmajw";
      else if(chord == Chords.ThreeMajor)
         return " Emajw";
      else if(chord == Chords.FourMajor)
         return " Fmajw";
      else if(chord == Chords.FiveMajor)
         return " Gmajw";
      else // if(chord == Chords.SixMajor)
         return " Amajw";
   ...
   private String[] getChordTones(Chords measureChord) {
     ...
     // Cmaj 1, 3, 5 (thus index 0, 4)
      ...
      // Dmaj D, F#, A
      else if(measureChord == Chords.TwoMajor) {
         String[] tones = {"D", "F#", "A"};
         return tones;
      }
      // Emaj E, G#, B
      else if(measureChord == Chords.ThreeMajor) {
         String[] tones = {CMajor[2], "G#", CMajor[6]};
         return tones;
      }
      // Fmaj 4, 6, 1
      ...
      // Amin A, C#, E
      else /* if(measureChord == Chords.SixMajor) */ {
         String[] tones = {"A", "C#", "E"};
         return tones;
      }
   }
   ...
   // Example: Given 3, and that the current chord is TwoMajor, it will return either "E5 D5" or "G5 A5" 
   // Alternate:
   ...
   private Chords[] generateProgression() {
      ...
      while(resolved == false) {
         ...
         if(seventhChord == Chords.TwoMajor || seventhChord == Chords.ThreeMajor || seventhChord == Chords.FourMajor || seventhChord == Chords.SixMajor) {
            resolved = true;
